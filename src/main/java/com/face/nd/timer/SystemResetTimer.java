...
import com.face.nd.task.SystemResetTaskService;
...
public class SystemResetTimer {
    ...
    private Logger logger = LoggerFactory.getLogger(SystemResetTimer.class);
    //时间间隔(一天)
    private long PERIOD_DAY = 24 * 60 * 60 * 1000;

    public void open() {
        Calendar calendar = Calendar.getInstance();
        calendar.set(Calendar.HOUR_OF_DAY, EgciController.configEntity.getSynchronizationHour() - 1);//比同步时间提前1个小时
